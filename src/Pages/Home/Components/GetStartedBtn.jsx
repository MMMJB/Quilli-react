...
export default function GetStartedBtn() {
    return (<>
        <div className="text-base/[26px] text-white font-sans">
            ...
            <button onClick={_ => window.location.pathname = "/signup"} className="bg-brand cta-mask rounded-lg px-6 py-2 animate-cta-rev hover:animate-cta">Get Started</button>
        </div>
    </>)
}