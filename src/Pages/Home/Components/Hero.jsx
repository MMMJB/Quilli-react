...
export default function Hero() {
    return (<>
        <main className="grid grid-cols-2 w-full max-w-[1350px]">
            <div className="flex flex-col justify-center pl-28 font-display text-home">
                <h1 className="text-[54px]/[64.8px] tracking-tight">Write incredible <span className="text-brand font-script">poetry</span> with the aid of AI</h1>
