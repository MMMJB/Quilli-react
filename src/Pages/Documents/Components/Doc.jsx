...
export default function Doc({title, type, meter}) {
    return (
        <li className="flex flex-col w-52 h-80 border-gray-border/50 border-[1px] rounded-md shadow-sm hover:shadow-lg transition-shadow cursor-pointer">
